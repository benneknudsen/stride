  ...
  return (
    <main className="flex min-h-[60vh] items-center justify-center px-3">
      <GlassCard className="max-w-[420px] p-10 text-center">
        <div className="font-cg-mono text-[11px] uppercase tracking-[0.2em] text-red">
          404 · Aktivitet
        </div>
        ...
        <Link
          ...
          className="cg-interactive mt-6 inline-flex min-h-[44px] items-center rounded-pill border border-cobalt bg-cobalt px-[18px] py-2 font-cg-mono text-[11px] uppercase tracking-[0.16em] text-silver"
        >
          Alle aktiviteter
        </Link>
      </GlassCard>
