...
//
// Recharts lives here so the coach route's initial bundle stays free of it — the
// ZoneDistributionChart wrapper pulls this in via next/dynamic (issue #250).

export function ZoneDistributionChartImpl({ data }: { data: ZoneWeek[] }) {
  return (
    <div>
