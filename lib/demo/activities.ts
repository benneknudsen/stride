...
export const demoActivities: Activity[] = [
  ...
  generateActivity(2, "Recovery Jog", 5.0, 6.1, 128, 172),
  generateActivity(4, "Long Run Sunday", 21.1, 5.25, 152, 180),
  generateActivity(5, "Hill Repeats", 7.5, 5.05, 168, 176, "TrailRun"),
  generateActivity(7, "Easy Miles", 9.0, 5.4, 140, 178),
  generateActivity(8, "Track Session", 8.0, 4.3, 172, 188, "TrackRun"),
  generateActivity(9, "Recovery Run", 6.0, 6.0, 132, 174),
  generateActivity(11, "Long Run", 18.5, 5.3, 150, 180),
  generateActivity(12, "Fartlek Fun", 10.5, 5.0, 158, 182),
  ...
  generateActivity(39, "Long Slow Distance", 24.0, 5.4, 148, 178),
  generateActivity(40, "Progression", 13.0, 5.1, 158, 182),
];
